<x-app-layout>
    <x-slot name="header">
        <h2 class="text-xl font-semibold leading-tight text-gray-800">Cadastrar partida</h2>
    </x-slot>
            ...
            <div class="rounded-lg border border-gray-200 bg-white p-6 shadow-sm">
                <form action="{{ route('partidas.store') }}" method="POST">
                    ...
                    <div class="mt-6 flex items-center gap-3 border-t border-gray-200 pt-5">
                        ...
                        <a href="{{ route('partidas.index') }}" class="text-sm font-medium text-gray-600 hover:text-gray-900">Cancelar</a>
                    </div>
                </form>
            </div>
        </div>
